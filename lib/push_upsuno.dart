...
class PushUpsuno extends StatelessWidget {
  @override
        ...
        children: <Widget>[
          Card(
            ...
            child: Stack(
              ...
              children: [
                Ink.image(
                  image: NetworkImage(
                    'https://images.pexels.com/photos/4162487/pexels-photo-4162487.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
                  ),
                  height: 220,
                  fit: BoxFit.cover,
                ),
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Crunchesuno()),
              );
            },
            child: Container(
              width: 200,
