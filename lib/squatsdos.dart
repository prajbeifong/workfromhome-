...
import 'mnt_climbuno.dart';
import 'mnt_climbdos.dart';

class Squatsdos extends StatelessWidget {
  @override
        ...
        children: <Widget>[
          Card(
            ...
            child: Stack(
              ...
              children: [
                Ink.image(
                  image: NetworkImage(
                    'https://images.pexels.com/photos/4384679/pexels-photo-4384679.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
                  ),
                  height: 220,
                  fit: BoxFit.cover,
                ),
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => MntClimbdos()),
              );
            },
            child: Container(
              width: 200,
