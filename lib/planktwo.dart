...
class Planktwo extends StatefulWidget {
  @override
  _PlanktwoState createState() => _PlanktwoState();
}

class _PlanktwoState extends State<Planktwo> {
  int _counter = 90;
  Timer _timer;
          ...
          children: <Widget>[
            Card(
              ...
              child: Stack(
                ...
                children: [
                  Ink.image(
                    image: NetworkImage(
                      'https://images.pexels.com/photos/3768901/pexels-photo-3768901.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
                    ),
                    height: 220,
                    fit: BoxFit.cover,
                  ),
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => PushUpsdos()),
                );
              },
              child: Container(
                width: 250,
